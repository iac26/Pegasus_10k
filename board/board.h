 ...
 * IO pins assignments.
 */
#define GPIOA_TEMP_1                0U
#define GPIOA_TEMP_2                1U
#define GPIOA_PRES_2                2U
#define GPIOA_TEMP_3                3U
...
#define GPIOA_SD1_TX                9U
#define GPIOA_ARD_D2                10U
#define GPIOA_OTG_FS_DM             11U
#define GPIOA_OTG_FS_DP             12U
#define GPIOA_SWDIO                 13U
#define GPIOA_SWCLK                 14U
#define GPIOA_BUZZER                15U
...
#define GPIOB_SOLENOID              7U
#define GPIOB_ARD_D15               8U
#define GPIOB_ARD_D14               9U
#define GPIOB_DEBUG_TX              10U
#define GPIOB_PIN11                 11U
#define GPIOB_PIN12                 12U
#define GPIOB_PIN13                 13U
#define GPIOB_LED_GREEN             14U
#define GPIOB_LED_BLUE              15U

#define GPIOC_PRES_1                0U
#define GPIOC_ARD_A4                1U
#define GPIOC_ADC123_IN11           1U
#define GPIOC_PIN2                  2U
#define GPIOC_PIN3                  3U
#define GPIOC_PIN4                  4U
#define GPIOC_DEBUG_RX              5U
#define GPIOC_MOTOR_TX              6U
#define GPIOC_MOTOR_RX              7U
 ...
 */
#define LINE_TEMP_1                 PAL_LINE(GPIOA, 0U)
#define LINE_TEMP_2                 PAL_LINE(GPIOA, 1U)
#define LINE_PRES_2                 PAL_LINE(GPIOA, 2U)
#define LINE_TEMP_3                 PAL_LINE(GPIOA, 3U)
...
#define LINE_SD1_TX                 PAL_LINE(GPIOA, 9U)
#define LINE_ARD_D2                 PAL_LINE(GPIOA, 10U)
#define LINE_OTG_FS_DM              PAL_LINE(GPIOA, 11U)
#define LINE_OTG_FS_DP              PAL_LINE(GPIOA, 12U)
#define LINE_SWDIO                  PAL_LINE(GPIOA, 13U)
#define LINE_SWCLK                  PAL_LINE(GPIOA, 14U)
#define LINE_BUZZER                 PAL_LINE(GPIOA, 15U)
...
#define LINE_SOLENOID               PAL_LINE(GPIOB, 7U)
#define LINE_ARD_D15                PAL_LINE(GPIOB, 8U)
#define LINE_ARD_D14                PAL_LINE(GPIOB, 9U)
#define LINE_DEBUG_TX               PAL_LINE(GPIOB, 10U)
#define LINE_LED_GREEN              PAL_LINE(GPIOB, 14U)
#define LINE_LED_BLUE               PAL_LINE(GPIOB, 15U)
#define LINE_PRES_1                 PAL_LINE(GPIOC, 0U)
#define LINE_ARD_A4                 PAL_LINE(GPIOC, 1U)
#define LINE_ADC123_IN11            PAL_LINE(GPIOC, 1U)
#define LINE_DEBUG_RX               PAL_LINE(GPIOC, 5U)
#define LINE_MOTOR_TX               PAL_LINE(GPIOC, 6U)
#define LINE_MOTOR_RX               PAL_LINE(GPIOC, 7U)
 ...
 * PA5  - ARD_D13                   (output pushpull high).
 * PA6  - ARD_D12                   (input pullup).
 * PA7  - LED_RED                   (alternate 3).
 * PA8  - ARD_D7                    (input pullup).
 * PA9  - SD1_TX                    (input pullup).
 * PA10 - ARD_D2                    (input pullup).
 * PA11 - OTG_FS_DM                 (alternate 10).
 * PA12 - OTG_FS_DP                 (alternate 10).
 * PA13 - SWDIO                     (alternate 0).
 * PA14 - SWCLK                     (alternate 0).
 * PA15 - BUZZER                    (output pushpull maximum).
 */
#define VAL_GPIOA_MODER             (PIN_MODE_ANALOG(GPIOA_TEMP_1) |        \
                                     PIN_MODE_ANALOG(GPIOA_TEMP_2) |        \
                                     PIN_MODE_ANALOG(GPIOA_PRES_2) |        \
                                     PIN_MODE_ANALOG(GPIOA_TEMP_3) |        \
                                     PIN_MODE_INPUT(GPIOA_ARD_A2) |         \
                                     PIN_MODE_OUTPUT(GPIOA_ARD_D13) |       \
                                     PIN_MODE_INPUT(GPIOA_ARD_D12) |        \
                                     PIN_MODE_ALTERNATE(GPIOA_LED_RED) |    \
                                     PIN_MODE_INPUT(GPIOA_ARD_D7) |         \
                                     PIN_MODE_INPUT(GPIOA_SD1_TX) |         \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_TEMP_1) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOA_TEMP_2) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PRES_2) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOA_TEMP_3) |     \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOA_SD1_TX) |     \
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_HIGH(GPIOA_TEMP_1) |        \
                                     PIN_OSPEED_HIGH(GPIOA_TEMP_2) |        \
                                     PIN_OSPEED_HIGH(GPIOA_PRES_2) |        \
                                     PIN_OSPEED_HIGH(GPIOA_TEMP_3) |        \
                                     PIN_OSPEED_HIGH(GPIOA_ARD_A2) |        \
                                     PIN_OSPEED_MEDIUM(GPIOA_ARD_D13) |     \
                                     PIN_OSPEED_HIGH(GPIOA_ARD_D12) |       \
                                     PIN_OSPEED_HIGH(GPIOA_LED_RED) |       \
                                     PIN_OSPEED_HIGH(GPIOA_ARD_D7) |        \
                                     PIN_OSPEED_HIGH(GPIOA_SD1_TX) |        \
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_FLOATING(GPIOA_TEMP_1) |     \
                                     PIN_PUPDR_FLOATING(GPIOA_TEMP_2) |     \
                                     PIN_PUPDR_FLOATING(GPIOA_PRES_2) |     \
                                     PIN_PUPDR_FLOATING(GPIOA_TEMP_3) |     \
...
#define VAL_GPIOA_ODR               (PIN_ODR_HIGH(GPIOA_TEMP_1) |           \
                                     PIN_ODR_HIGH(GPIOA_TEMP_2) |           \
                                     PIN_ODR_HIGH(GPIOA_PRES_2) |           \
                                     PIN_ODR_HIGH(GPIOA_TEMP_3) |           \
                                     ...
                                     PIN_ODR_HIGH(GPIOA_SD1_TX) |           \
                                     PIN_ODR_HIGH(GPIOA_ARD_D2) |           \
                                     PIN_ODR_HIGH(GPIOA_OTG_FS_DM) |        \
                                     PIN_ODR_HIGH(GPIOA_OTG_FS_DP) |        \
                                     PIN_ODR_HIGH(GPIOA_SWDIO) |            \
                                     PIN_ODR_HIGH(GPIOA_SWCLK) |            \
                                     PIN_ODR_HIGH(GPIOA_BUZZER))
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_TEMP_1, 0U) |        \
                                     PIN_AFIO_AF(GPIOA_TEMP_2, 0U) |        \
                                     PIN_AFIO_AF(GPIOA_PRES_2, 0U) |        \
                                     PIN_AFIO_AF(GPIOA_TEMP_3, 0U) |        \
                                     PIN_AFIO_AF(GPIOA_ARD_A2, 0U) |        \
                                     PIN_AFIO_AF(GPIOA_ARD_D13, 0U) |       \
                                     PIN_AFIO_AF(GPIOA_ARD_D12, 0U) |       \
                                     PIN_AFIO_AF(GPIOA_LED_RED, 3U))
#define VAL_GPIOA_AFRH              (PIN_AFIO_AF(GPIOA_ARD_D7, 0U) |        \
                                     PIN_AFIO_AF(GPIOA_SD1_TX, 7U) |        \
                                     PIN_AFIO_AF(GPIOA_ARD_D2, 0U) |        \
                                     PIN_AFIO_AF(GPIOA_OTG_FS_DM, 10U) |    \
                                     PIN_AFIO_AF(GPIOA_OTG_FS_DP, 10U) |    \
                                     PIN_AFIO_AF(GPIOA_SWDIO, 0U) |         \
                                     PIN_AFIO_AF(GPIOA_SWCLK, 0U) |         \
                                     PIN_AFIO_AF(GPIOA_BUZZER, 0U))
 ...
 * PB7  - SOLENOID                  (output pushpull maximum).
 * PB8  - ARD_D15                   (input pullup).
 * PB9  - ARD_D14                   (input pullup).
 * PB10 - DEBUG_TX                  (alternate 7).
 * PB11 - PIN11                     (input pullup).
 * PB12 - PIN12                     (input pullup).
 * PB13 - PIN13                     (input pullup).
 * PB14 - LED_GREEN                 (alternate 3).
 * PB15 - LED_BLUE                  (alternate 3).
 */
#define VAL_GPIOB_MODER             (PIN_MODE_INPUT(GPIOB_ARD_A3) |         \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOB_SOLENOID) |      \
                                     ...
                                     PIN_MODE_ALTERNATE(GPIOB_LED_GREEN) |  \
                                     PIN_MODE_ALTERNATE(GPIOB_LED_BLUE))
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_ARD_A3) |     \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_SOLENOID) |   \
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_HIGH(GPIOB_ARD_A3) |        \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOB_SOLENOID) |      \
                                     PIN_OSPEED_HIGH(GPIOB_ARD_D15) |       \
                                     PIN_OSPEED_HIGH(GPIOB_ARD_D14) |       \
                                     PIN_OSPEED_HIGH(GPIOB_DEBUG_TX) |      \
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_PULLUP(GPIOB_ARD_A3) |       \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOB_SOLENOID) |   \
...
#define VAL_GPIOB_AFRL              (PIN_AFIO_AF(GPIOB_ARD_A3, 0U) |        \
                                     ...
                                     PIN_AFIO_AF(GPIOB_SOLENOID, 0U))
#define VAL_GPIOB_AFRH              (PIN_AFIO_AF(GPIOB_ARD_D15, 0U) |       \
                                     PIN_AFIO_AF(GPIOB_ARD_D14, 0U) |       \
                                     PIN_AFIO_AF(GPIOB_DEBUG_TX, 7U) |      \
                                     PIN_AFIO_AF(GPIOB_PIN11, 0U) |         \
                                     PIN_AFIO_AF(GPIOB_PIN12, 0U) |         \
                                     PIN_AFIO_AF(GPIOB_PIN13, 0U) |         \
                                     PIN_AFIO_AF(GPIOB_LED_GREEN, 3U) |     \
                                     PIN_AFIO_AF(GPIOB_LED_BLUE, 3U))
 ...
 * PC5  - DEBUG_RX                  (alternate 7).
 * PC6  - MOTOR_TX                  (alternate 8).
 * PC7  - MOTOR_RX                  (alternate 8).
 ...
 */
#define VAL_GPIOC_MODER             (PIN_MODE_ANALOG(GPIOC_PRES_1) |        \
                                     PIN_MODE_INPUT(GPIOC_ARD_A4) |         \
                                     PIN_MODE_INPUT(GPIOC_PIN2) |           \
                                     PIN_MODE_INPUT(GPIOC_PIN3) |           \
                                     PIN_MODE_INPUT(GPIOC_PIN4) |           \
                                     PIN_MODE_ALTERNATE(GPIOC_DEBUG_RX) |   \
                                     PIN_MODE_ALTERNATE(GPIOC_MOTOR_TX) |   \
                                     PIN_MODE_ALTERNATE(GPIOC_MOTOR_RX) |   \
...
#define VAL_GPIOC_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOC_PRES_1) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOC_ARD_A4) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PIN2) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PIN3) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PIN4) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOC_DEBUG_RX) |   \
                                     PIN_OTYPE_PUSHPULL(GPIOC_MOTOR_TX) |   \
                                     PIN_OTYPE_PUSHPULL(GPIOC_MOTOR_RX) |   \
...
#define VAL_GPIOC_OSPEEDR           (PIN_OSPEED_HIGH(GPIOC_PRES_1) |        \
                                     PIN_OSPEED_HIGH(GPIOC_ARD_A4) |        \
                                     PIN_OSPEED_HIGH(GPIOC_PIN2) |          \
                                     PIN_OSPEED_HIGH(GPIOC_PIN3) |          \
                                     PIN_OSPEED_HIGH(GPIOC_PIN4) |          \
                                     PIN_OSPEED_HIGH(GPIOC_DEBUG_RX) |      \
                                     PIN_OSPEED_HIGH(GPIOC_MOTOR_TX) |      \
                                     PIN_OSPEED_HIGH(GPIOC_MOTOR_RX) |      \
...
#define VAL_GPIOC_PUPDR             (PIN_PUPDR_FLOATING(GPIOC_PRES_1) |     \
                                     PIN_PUPDR_PULLUP(GPIOC_ARD_A4) |       \
                                     PIN_PUPDR_PULLUP(GPIOC_PIN2) |         \
                                     PIN_PUPDR_PULLUP(GPIOC_PIN3) |         \
                                     PIN_PUPDR_PULLUP(GPIOC_PIN4) |         \
                                     PIN_PUPDR_PULLUP(GPIOC_DEBUG_RX) |     \
                                     PIN_PUPDR_PULLUP(GPIOC_MOTOR_TX) |     \
                                     PIN_PUPDR_PULLUP(GPIOC_MOTOR_RX) |     \
...
#define VAL_GPIOC_ODR               (PIN_ODR_HIGH(GPIOC_PRES_1) |           \
                                     PIN_ODR_HIGH(GPIOC_ARD_A4) |           \
                                     PIN_ODR_HIGH(GPIOC_PIN2) |             \
                                     PIN_ODR_HIGH(GPIOC_PIN3) |             \
                                     PIN_ODR_HIGH(GPIOC_PIN4) |             \
                                     PIN_ODR_HIGH(GPIOC_DEBUG_RX) |         \
                                     PIN_ODR_HIGH(GPIOC_MOTOR_TX) |         \
                                     PIN_ODR_HIGH(GPIOC_MOTOR_RX) |         \
...
#define VAL_GPIOC_AFRL              (PIN_AFIO_AF(GPIOC_PRES_1, 0U) |        \
                                     PIN_AFIO_AF(GPIOC_ARD_A4, 0U) |        \
                                     PIN_AFIO_AF(GPIOC_PIN2, 0U) |          \
                                     PIN_AFIO_AF(GPIOC_PIN3, 0U) |          \
                                     PIN_AFIO_AF(GPIOC_PIN4, 0U) |          \
                                     PIN_AFIO_AF(GPIOC_DEBUG_RX, 7U) |      \
                                     PIN_AFIO_AF(GPIOC_MOTOR_TX, 8U) |      \
                                     PIN_AFIO_AF(GPIOC_MOTOR_RX, 8U))
